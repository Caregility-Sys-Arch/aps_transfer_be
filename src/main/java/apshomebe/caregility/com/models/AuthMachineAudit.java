...
public class AuthMachineAudit extends Auditable<String> {
	...
	public AuthMachineAudit() {
		super();
	}

	public AuthMachineAudit(String machineName, String machineUri, String machineUriToDisplay, String machineVin,
